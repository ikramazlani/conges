...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(User request) {
        ...
        return new AuthenticationResponse(accessToken, refreshToken,"User registration was successful",user.getRole().name());
    }
    ...
    public AuthenticationResponse authenticate(User request) {
        ...
        return new AuthenticationResponse(accessToken, refreshToken, "User login was successful", user.getRole().name());
    ...
    public ResponseEntity refreshToken(
        ...
        if(jwtService.isValidRefreshToken(token, user)) {
            ...
            return new ResponseEntity(new AuthenticationResponse(accessToken, refreshToken, "New token generated",user.getRole().name()), HttpStatus.OK);
        }
